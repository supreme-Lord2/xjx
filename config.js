...
module.exports = {
    ...
    ownerNumber: ['254798952773',''], // Add your number without + or spaces (e.g., 919876543210)
    ...
    updateZipUrl: 'https://github.com/vinpink2/june-x/archive/refs/heads/main.zip', // URL to latest code zip for .update command
